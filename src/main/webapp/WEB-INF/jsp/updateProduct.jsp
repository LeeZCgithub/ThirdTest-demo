...
<form class="form-horizontal text-area" role="form" style="width:80%" action="${pageContext.request.contextPath}/product/updateProduct" method="post" enctype="multipart/form-data">
