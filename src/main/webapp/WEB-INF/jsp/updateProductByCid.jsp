...
<body>
<h1 align="" class="text-center" >修改页面</h1>
<form class="form-horizontal text-area" role="form" style="width:80%" action="${pageContext.request.contextPath}/product/updateProductByCid" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group" >
        ...
        <div class="col-sm-10">
            <input class="form-control" name="pimage1" type="file" value="">
            <input class="form-control" name="pimage" type="hidden" value="${product.pimage}">
        </div>
    </div>
    <div class="form-group" >
        <label class="col-sm-2 control-label">是否热门</label>
        <div class="col-sm-10">
            <input type="hidden" id="hot" value="${product.hot}"/>
...
<script>
    ...
    if ("是"==hot){
        ...
        document.getElementById("nothot").checked=true;
    }
</script>
