    ...
    <table width="80%" class="table table-striped table-bordered table-hover table-condensed">
        ...
        <c:forEach items="${productList}" var="product" varStatus="i">
            <tr class="active">
                ...
                <td class="tab-content-area">
                    <button class="btn btn-default" type="button" onclick="location.href='${pageContext.request.contextPath}/product/deleteProductByCid?pid=${product.pid}&currentPage=${currentPage}&pageSize=${pageSize}&cid=${cid}'">删除</button>
                </td>
                <td class="tab-content-area">
                    <button class="btn btn-default" type="button" onclick="location.href='${pageContext.request.contextPath}/product/toUpdateProductByCid?pid=${product.pid}&currentPage=${currentPage}&pageSize=${pageSize}&cid=${cid}'">修改</button>
                </td>
    ...
    <nav  style=" align-content: center;align-items: center" aria-label="Page navigation">
        <ul class="pagination">
            ...
            <c:forEach begin="1" end="${pageNumber}" var="i">
                <li ><a href="${pageContext.request.contextPath}/product/showProductsByCid?currentPage=${i}&cid=${cid}">${i}</a></li>
            </c:forEach>
